...
class _StaffDetailsPageState extends State<StaffDetailsPage> {
  ...
  void initState() {
    ...
    _contactController = TextEditingController(text: widget.staff.contact);
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      await _firestore.collection('staff').doc(widget.staff.id).update({
  ...
  void _deleteStaff() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to delete ${widget.staff.fullName}? This action cannot be undone.',
